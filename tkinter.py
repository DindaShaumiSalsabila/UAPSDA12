...
class WelcomeApp:
    ...
    def show_welcome_page(self):
        ...
        tk.Label(self.welcome_frame, text="Selamat datang di presentasi kami!", font=self.subheader_font, fg="#FF75DC", bg="#FFFFFF").pack(pady=20)
    ...
    def create_member_card(self, parent, name, role, row, col):
        ...
        photo_label = tk.Label(card_frame, text="[Foto Anggota]", font=self.card_font, fg="#ffffff", bg="#FF75DC")
        photo_label.pack(pady=15, expand=True, fill="both")
        tk.Label(card_frame, text=name, font=self.name_font,fg="#ffffff", bg="#FF75DC").pack()
        tk.Label(card_frame, text=role, font=self.subheader_font,fg="#bfdbfe", bg="#FF75DC").pack(pady=10)
